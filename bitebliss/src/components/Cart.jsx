        ...
        <Container className="mt-4">
            {!showForm ? (
                <div>
                    ...
                    <div className="text-center align-middle">
                        <Button variant="danger" className="btn-lg mt-4 fw-bold me-3" onClick={handleClearCart}>
                            Limpiar Carrito
                        </Button>
                        <Button variant="primary" className="btn btn-dark btn-lg mt-4 fw-bold" onClick={() => setShowForm(true)}>
                            Checkout
                        </Button>
                    </div>
                </div>
...
<div className="text-center align-middle">
<Button
className="btn btn-dark btn-lg mt-4 fw-bold me-5"
